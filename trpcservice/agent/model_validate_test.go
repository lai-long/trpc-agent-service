...
func TestValidateModelSpec(t *testing.T) {
	cases := []struct {
		...
		{"plain http allowed on loopback", "http://127.0.0.1:8000", []string{"127.0.0.1"}, false},
		{"plain http allowed on localhost", "http://localhost:8000", []string{"localhost"}, false},
		{"loopback still needs the allowlist", "http://127.0.0.1:8000", nil, true},
